...
class TieredScheduler:
    ...
    def start(self) -> None:
        ...
        self._scheduler.add_job(
            self._run_tier, "interval", hours=1, args=["hourly"], id="hourly"
        )
        self._scheduler.add_job(
            self._run_tier, "interval", hours=24, args=["daily"], id="daily"
        )
        self._scheduler.add_job(
            self._run_tier, "interval", weeks=1, args=["weekly"], id="weekly"
        )
