# phenotype-research-engine User Journeys
...
|---------|----------|-------------|
| [Quick Start](./quick-start) | < 5 min | Get started with phenotype-research-engine |
...
flowchart TB
    ...
    subgraph phenotype-research-engine["phenotype-research-engine"]
        API[API Layer]
        Core[Core Engine]
        Storage[Storage]
    end
